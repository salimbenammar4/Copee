...
const DemandeBallon = () => {
    ...
    const [selectedOption1, setSelectedOption1] = useState('Thermosiphon');
    ...
    const saveDataToFirestore = async () => {
        ...
        if (user) {
            try {
                const demandeData = {
                    userId: user.uid,
                    TypeInstallation:"Ballons Solaires",
                    typeBallonSolaire: selectedOption1,
            ...
            <>
                ...
                <View style={style.header}>
                    ...
                    <View style={style.titleContainer}>
                        <Text style={style.title}>Demande pour Ballons Solaires</Text>
                    </View>
                ...
                <ScrollView>
                    <View style={styles.hero}>
                        ...
                        <Text  style={[style.subtitle, {textAlign: 'left'}]}>Type de Ballon Solaire:</Text>
                        <View style={style.pickerContainer}>
                            <Picker
                                ...
                                style={style.picker}
                            >
                                <Picker.Item label="Thermosiphon" value="Thermosiphon" />
                                <Picker.Item label="Monobloc" value="Monobloc" />
                                <Picker.Item label="A circulation forcée" value="A circulation forcée" />
                                <Picker.Item label="A auto vidange" value="A auto vidange" />
                            </Picker>
                        </View>
