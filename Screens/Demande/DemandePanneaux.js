...
const DemandePanneaux = () => {
    const navigation = useNavigation();
    const [selectedOption1, setSelectedOption1] = useState('1500 Wc');
                    ...
                    <View style={styles.hero}>
                        ...
                        <View style={style.pickerContainer}>
                            <Picker
                                ...
                                style={style.picker}
                            >
                                <Picker.Item label="1500 Wc" value="1500 Wc" />
                                <Picker.Item label="3000 Wc" value="3000 Wc" />
                                <Picker.Item label="7000 Wc" value="7000 Wc" />
                                <Picker.Item label="10000 Wc" value="10000 Wc" />
                                <Picker.Item label="15000 Wc" value="15000 Wc" />
                                <Picker.Item label="20000 Wc" value="20000 Wc" />
                                <Picker.Item label="25000 Wc" value="25000 Wc" />
                            </Picker>
                        </View>
...
export default DemandePanneaux;
