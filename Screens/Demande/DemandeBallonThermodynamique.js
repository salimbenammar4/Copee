            ...
            <>
                ...
                <View style={style.header}>
                    ...
                    <View style={style.titleContainer}>
                        <Text style={style.title}>Demande pour Ballons Thermodynamiques</Text>
                    </View>
                    ...
                    <View style={styles.hero}>
                        ...
                        <View style={style.pickerContainer}>
                            <Picker
                                ...
                                style={style.picker}
                            >
                                <Picker.Item label="A air ambiant" value="A air ambiant" />
                                <Picker.Item label="A air exterieur" value="A air exterieur" />
                                <Picker.Item label="A air extrait" value="A air extrait" />
                            </Picker>
                        </View>
